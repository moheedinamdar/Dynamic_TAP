...
public class jClass {
    ...
    protected jVehicle defaultVehicle;
    ...
    public jClass(jModel model, jVehicle vehicle, int id){
        this.model = model;
        this.id = id;
     ...
     */
    public jVehicle generateVehicle() {
        // start of with the default vehicle
        jVehicle veh = copyDefaultVehicle();
     ...
     */
    protected jVehicle copyDefaultVehicle() {
        // new vehicle
        jVehicle veh = new jVehicle(model);
     ...
     */
    protected void setStochasticParameters(jVehicle veh) {
