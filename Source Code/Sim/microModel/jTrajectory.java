...
public class jTrajectory {
     ...
     */
    public jTrajectory(jVehicle veh, String FCDclass) throws ClassNotFoundException {
        vehicle = veh;
        if (FCDclass!=null) {
    ...
    /**
     * Appends current data of vehicle to an internal array at appropiate interval.
     */
    public void append() {
        if (!tDataSet) {
        ...
        if (vehicle.model.settings.getBoolean("storeTrajectoryData") && 
            ...
            try {
                FCD.add((jFCD) FCDclass.getConstructor(vehicle.getClass()).newInstance(vehicle));
            } catch (Exception e) {
     ...
     * return an appropiate subclass of <tt>jTrajectoryData</tt>.
     * @return The trajectory as serializable <tt>jTrajectoryData</tt> object.
     */
    public jTrajectoryData asSerializable() {
        return new jTrajectoryData(this);
    }
        ...
        try {
            if (!asPrimitive || field.getType().isPrimitive()) {
                if (field.get(FCD.get(0)) instanceof Double) {
                    ...
                    java.util.ArrayList dat = new java.util.ArrayList();
                    for (int i=0; i<n; i++) {
     ...
     */
    public void addScalars(jTrajectoryData t) {
        try {
            java.lang.reflect.Method method = FCDclass.getMethod("addScalars",
                    jTrajectoryData.class, jVehicle.class);
