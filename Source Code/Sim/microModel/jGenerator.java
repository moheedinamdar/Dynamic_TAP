 ...
 */
public class jGenerator extends jController {
    ...
    protected jVehicle nextVehicle; // next vehicle
    ...
    public jGenerator(jLane lane, distribution dist) {
        super(lane.model);
        this.lane = lane;
        this.dist = dist;
        lane.generator = this;
    ...
    /**
     * Vehicle generation method. A new vehicle is generated if appropiate.
     */
    public void control() {
        ...
        if (dist == distribution.PREDEFINED) {
            ...
            while (tNext<=lane.model.t) {
                ...
                jClass vehClass = lane.model.getClass(preClass[generated]);
                // generate vehicle
    ...
    protected boolean addFreeVehicle() {
        ...
        while (!success && genLane!=null) {
            ...
            jMovable down = genLane.findVehicle(0, jModel.longDirection.DOWN);
            double downX;
            if (down!=null) {
     ...
     */
    protected void passRSUs(jVehicle veh) {
