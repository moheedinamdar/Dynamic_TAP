 ...
 * lanes longitudinally in an appropiate way. A crossing conflict may or may not 
 * be an area that needs to be kept clear (depending on driver compliance). 
 */
public class jConflict {
     ...
     */
    protected jConflict(jLane pLane, double pX, jLane yLane, double yX,
     ...
     */
    public static jConflict createMerge(jLane mLane, jLane pLane, jLane yLane) {
     ...
     * @return Merge conflict, <tt>null</tt> if lanes do not intersect.
     */
    protected static jConflict createMerge(jLane pLane, jLane yLane) {
        coord intersect;
        ...
        if (intersect==null) {
            ...
            if (clearance!=null && clearance[0]!=null) {
                return new jConflict(pLane, intersect.x1, yLane, intersect.x2,  
     ...
     */
    public static jConflict createSplit(jLane sLane, jLane lane1, jLane lane2) {
     ...
     * @return Split conflict, <tt>null</tt> if lanes do not intersect.
     */
    protected static jConflict createSplit(jLane lane1, jLane lane2) {
        coord intersect;
        ...
        if (intersect==null) {
            ...
            if (clearance!=null && clearance[1]!=null) {
                return new jConflict(lane1, clearance[1].x1, lane2, clearance[1].x2,
     ...
     */
    public static jConflict createCrossing(jLane pLane, jLane yLane, boolean clear) {
        ...
        if (intersect==null) {
            ...
            if (clearance!=null && clearance[0]!=null && clearance[1]!=null) {
                return new jConflict(pLane, clearance[1].x1, yLane, clearance[1].x2,  
     ...
     */
    protected static coord intersect(jLane lane1, jLane lane2) {
     ...
     */
    protected static coord[] findClearanceSpace(jLane lane1, jLane lane2, coord intersect, boolean crossing) {
     ...
     */
    public void setVisibilityFrom(jLane lane, double x) {
        vLane = lane;
        vX = x;
    }
     ...
     */
    public class conflictRSU extends jSpeedReduction {
        ...
        protected java.util.ArrayList<jConflict.conflictRSU> upstreamMergeConflicts = 
            new java.util.ArrayList<jConflict.conflictRSU>();
        
        /** Merge conflict which delivered an upstream vehicle. */
        protected jConflict.conflictRSU mergeConflictOfUp = null;
        
        /**
         * Constructor which sets the appropiate information.
         ...
         */
        public conflictRSU(jLane lane, double x, boolean priority) {
            super(lane, x);
         ...
         */
        public jMovable up() {
            // check whether upstream vehicle hasnt been deleted
        ...
        public void init() {
            ...
            if (j!=null && j.isMerge()) {
                for (jLane k : j.ups) {
                    // find appropiate rsu on lane
                    double xRsu = 0;
                    boolean found = false;
                    while (!found) {
                        java.util.ArrayList<jRSU> rsus = k.findNoticeableRSU(xRsu, k.l-xRsu);
                        for (jRSU rsu : rsus) {
                            if (rsu instanceof jConflict.conflictRSU) {
                                jConflict.conflictRSU rsu2 = (jConflict.conflictRSU) rsu;
                                if (rsu2.isMerge()) {
        ...
        public void control() {
            ...
            if (up!=null && up instanceof jLcVehicle && ((jLcVehicle) up).vehicle==null) {
                up = null;
            }
            ...
            if (up==null) {
                up = lane.findVehicle(x, jModel.longDirection.UP);
            }
            ...
            if (up==null) {
                ...
                for (jConflict.conflictRSU rsu : upstreamMergeConflicts) {
                    jMovable up2 = rsu.up();
                    if (up2!=null) {
