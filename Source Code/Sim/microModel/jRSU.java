 ...
 */
public abstract class jRSU extends jController {
     ...
     */
    public jRSU(jLane lane, double x, boolean passable, boolean noticeable) {
     ...
     * @param noticeable Whether the RSU is noticeable.
     */
    public jRSU(jLane lane, double x, double period, boolean passable, boolean noticeable) {
    ...
    public jRSU(jLane lane, double x, double period, double start, boolean passable, boolean noticeable) {
     ...
     */
    public abstract void pass(jVehicle vehicle);
}