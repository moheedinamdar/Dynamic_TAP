 ...
 */
public abstract class jOBU extends jController {
     ...
     */
    public jOBU(jVehicle vehicle, double period) {
    ...
    public jOBU(jVehicle vehicle, double period, double start) {
